...
def welcomeScreen():
    ...
    while True:
        for event in pygame.event.get():
            # If the user clicks on the close button or presses ESC, exit the game
            ...
            # If the user presses SPACE or UP key, start the game
                ...
                # Blit the background, player, message, and base onto the screen
...
def mainGame():
    ...
    while True:
        ...
        # Check if the player has collided with any pipes
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Panchi Bano')
    ...
    while True:
        welcomeScreen()  # Shows the welcome screen to the user until they press a button
